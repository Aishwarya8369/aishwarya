 ...
 *
 * Displays a sidebar with expandable category sections for filtering products
 *
 * @param {Object} props - Component props
 * @param {Function} props.onCategoryChange - Function to call when category is selected
            ...
            <div className="ml-2 space-y-1">
              {tShirtTypes.map((type) => (
                <button
                  ...
                  onClick={() => onCategoryChange(type, "tshirtType")}
                >
                  {type}
                </button>
              ))}
            ...
            <div className="ml-2 space-y-1">
              {comicThemes.map((theme) => (
                <button
                  ...
                  onClick={() => onCategoryChange(theme, "themeCategory")}
                >
                  {theme}
                </button>
              ))}
